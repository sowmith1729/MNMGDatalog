...
void benchmark(int argc, char** argv) {
    ...
    Entity* hash_table =
        get_hash_table(grid_size, block_size, t_delta, t_delta_size,
    ...
    Entity* base_join_result =
        get_join(grid_size, block_size, hash_table, hash_table_rows, t_delta,
                 t_delta_size, &base_join_size, &base_join_time);
    ...
    while (true) {
        ...
        Entity* first_join_result =
            get_join(grid_size, block_size, hash_table, hash_table_rows,
                     t_delta, t_delta_size, &first_join_size, &first_join_time);
