...
void benchmark(int argc, char **argv) {
    ...
    Entity *base_join_result = get_join_nl(grid_size, block_size, input_relation, input_relation_size, t_delta, t_delta_size,
                                        &base_join_size,
                                        &base_join_time);
...
//    }
    ...
    while (true) {
        ...
        Entity *first_join_result = get_join_nl(grid_size, block_size, input_relation, input_relation_size, t_delta, t_delta_size,
                                             &first_join_size,
                                             &first_join_time);
        ...
        Entity *second_join_result = get_join_nl(grid_size, block_size, input_relation, input_relation_size,
                                              distributed_first_join_result, distributed_first_join_size,
