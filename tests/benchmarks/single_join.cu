...
void benchmark(int argc, char** argv) {
    ...
    Entity* distributed_join_result = get_global_join(
        ...
        comm_method, iterations, &distributed_join_result_size, &temp_join_time,
    ...
    distributed_join_result_size = deduplicate(
    ...
    if (total_time == max_total_time) {
        ...
        printf(
            ...
            communication_time_before_join,
            buffer_preparation_time_after_join,
            communication_time_after_join, output.deduplication_time,
            memory_clear_time, copy_to_host_time, output.finalization_time,
